...
impl Control0 {
    ...
    #[inline]
    pub fn get_health_test_error(&self) -> u32 {
    ...
    #[inline]
    pub fn get_manual_function_select(&self) -> ManualFunctionSelect {
...
impl Test {
    ...
    #[inline]
    pub fn get_health_test_alarm_number(&self) -> u8 {
...
impl Control1 {
    ...
    #[inline]
    pub fn get_reseed_number_lsb(&self) -> u32 {
...
impl Control2 {
    ...
    #[inline]
    pub fn get_reseed_number_msb(&self) -> u16 {
...
impl Control3 {
    ...
    #[inline]
    pub fn get_conditional_component_compression_ration(&self) -> u8 {
    ...
    #[inline]
    pub fn get_ht_rct_cut_off_value(&self) -> u8 {
    ...
    #[inline]
    pub fn get_ht_apt_cut_off_value(&self) -> u16 {
...
mod tests {
    ...
    fn struct_register_block_offset() {
        ...
        assert_eq!(offset_of!(RegisterBlock, test_output), 0x38);
        assert_eq!(offset_of!(RegisterBlock, control_protection), 0x48);
    }
    ...
    fn struct_control0_functions() {
        ...
        // Test get_health_test_error function
        control0 = Control0(0);
        assert_eq!(control0.get_health_test_error(), 0);
    ...
    fn struct_test_functions() {
        ...
        assert_eq!(test.get_health_test_alarm_number(), alarm_number);
    ...
    fn struct_control1_functions() {
        ...
        assert_eq!(control1.get_reseed_number_lsb(), test_value);
    ...
    fn struct_control2_functions() {
        ...
        assert_eq!(control2.get_reseed_number_msb(), test_value);
    ...
    fn struct_control3_functions() {
        ...
        assert_eq!(control3.get_ht_rct_cut_off_value(), test_rct);
        ...
        assert_eq!(control3.get_ht_apt_cut_off_value(), test_apt);
