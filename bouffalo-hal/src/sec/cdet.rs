...
impl Control1 {
    ...
    #[inline]
    pub fn get_g_loop_max(&self) -> u16 {
    ...
    #[inline]
    pub fn get_g_loop_min(&self) -> u16 {
...
mod tests {
    ...
    fn struct_control_1_functions() {
        ...
        assert_eq!(control_1.get_g_loop_max(), 0x04D2);
        ...
        assert_eq!(control_1.get_g_loop_min(), 0x162E);
        ...
        assert_eq!(control_1.get_g_loop_max(), 0x270F);
        assert_eq!(control_1.get_g_loop_min(), 0x0457);
        ...
        assert_eq!(control_1.get_g_loop_max(), 0xFFFF);
        assert_eq!(control_1.get_g_loop_min(), 0x0000);
        assert_eq!(control_1.0, 0x0000FFFF);

        control_1.set_g_loop_min(0xFFFF);
        assert_eq!(control_1.get_g_loop_max(), 0xFFFF);
        assert_eq!(control_1.get_g_loop_min(), 0xFFFF);
        ...
        assert_eq!(control_1.get_g_loop_max(), 0);
        assert_eq!(control_1.get_g_loop_min(), 0);
    ...
    fn struct_control_2_functions() {
        ...
        assert_eq!(control_2.get_t_loop_n(), 1234);
        ...
        assert_eq!(control_2.get_t_dly_n(), 56);
        ...
        assert_eq!(control_2.get_g_slp_n(), 78);
        ...
        assert_eq!(control_2.get_t_loop_n(), 0xFFFF);
        assert_eq!(control_2.get_t_dly_n(), 0xFF);
        assert_eq!(control_2.get_g_slp_n(), 0xFF);
        ...
        assert_eq!(control_2.get_t_loop_n(), 0x1234);
        assert_eq!(control_2.get_t_dly_n(), 0);
        assert_eq!(control_2.get_g_slp_n(), 0);
        ...
        assert_eq!(control_2.get_t_loop_n(), 0);
        assert_eq!(control_2.get_t_dly_n(), 0);
        assert_eq!(control_2.get_g_slp_n(), 0);
    ...
    fn struct_control_3_functions() {
        ...
        assert_eq!(control_3.get_t_count(), 1234);
        ...
        assert_eq!(control_3.get_g_count(), 5678);
        ...
        assert_eq!(control_3.get_t_count(), 0xFFFF);
        assert_eq!(control_3.get_g_count(), 0xFFFF);
        assert_eq!(control_3.0, 0xFFFFFFFF); // Assert the hexadecimal value

        // Test that values don't interfere with each other
        control_3 = Control3(0);
        control_3.set_t_count(0x1234);
        assert_eq!(control_3.get_t_count(), 0x1234);
        assert_eq!(control_3.get_g_count(), 0);
        ...
        assert_eq!(control_3.get_t_count(), 0);
        assert_eq!(control_3.get_g_count(), 0);
